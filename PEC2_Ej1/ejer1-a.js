...
const findOne = (list, { key, value }, { onSuccess, onError }) => {
    //Mètode que executa de forma asíncrona un funcion passat x mil·lisegons, en aquest cas 2000 ms --> 2 s
    setTimeout(() => {
...
/*
    ...
    El resultat esperat, és un resultat vàlid, en aquest cas en el llistat d'users' es troba un objecte amb la key = 'name' i amb el valor 'Carlos', i executarà el callback onSuccess.
 */
...
/*
    El resultat esperat, és un resultat invàlid, en aquest cas en el llistat d'users' no té cap objecte amb la key = 'name' i amb el valor 'Fermin', aquesta vegada executar el callback onError.
 */
